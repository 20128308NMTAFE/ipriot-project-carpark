...
| ---------- |--------------------------------------|---------------------------------------------------------------------------------|
| `CarPark`    | parkingBays, cars, currentWeather          | getAvailableParkingBays(), addParkingBay(), removeParkingBay(), updateWeather() |
...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
   ...
   `The test that failed in the tutorial video passed in my program because I had this originally for my car_park.py
available_bays property:`

![img_6.png](img_6.png)

`But I have now changed it to match the tutorial video:`
![img_7.png](img_7.png)
...
> In the CarPark class, as the 'register' method belongs to the CarPark class. 
> Additionally, the registered sensors/displays are stored into the attributes of the CarPark class. 
